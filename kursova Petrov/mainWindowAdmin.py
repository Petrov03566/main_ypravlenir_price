...
class MainWindowAdmin(QtWidgets.QWidget):
    def setupUi(self, Admin_window):
        ...
        self.add_product_btn.setGeometry(QtCore.QRect(10, 410, 241, 51))
        font = QtGui.QFont()
        ...
        self.create_report_btn.setGeometry(QtCore.QRect(280, 410, 241, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.create_report_btn.setFont(font)
        self.create_report_btn.setObjectName("create_report_btn")
        self.add_product_btn_2 = QtWidgets.QPushButton(Admin_window)
        self.add_product_btn_2.setGeometry(QtCore.QRect(140, 480, 241, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, Admin_window):
        ...
        self.add_product_btn_2.setText(_translate("Admin_window", "Добавить менеджера"))
